...
RETURNING id, created_at, updated_at, title, descreption, published_at, url, feed_id
`
...
SELECT posts.id, posts.created_at, posts.updated_at, posts.title, posts.descreption, posts.published_at, posts.url, posts.feed_id from posts
